...
/// Стартовый геном: одна поперечная балка (влево-вправо, «гироскутер») и два
/// якоря (колесо + моторное колесо). Дальше эволюция сама добавит структуру,
/// если это выгодно.
Genotype startGenome(const Grammar gr)
{
    ...
    // 1.2 м справа налево (на манер гироскутера),
    // по вперёд/вверх — ноль.
